...
const stakeholderDefs: StakeholderDef[] = [
  ...
  { id:'s-004', name:'Michael Odhiambo', title:'CEO', org:'Kenya Renewable Energy Assoc.', sector:'business', layer:2, sensitive:false, gender:'male', I:4,R:5,K:1,S:5,A:5,M:4 },
  { id:'s-005', name:'Dr. Amina Abdullahi', title:'Commissioner', org:'Energy & Petroleum Regulatory Auth.', sector:'civil_service', layer:1, sensitive:false, gender:'female', I:5,R:4,K:1,S:4,A:4,M:5 },
  { id:'s-006', name:'Joseph Kipchoge', title:'Senior Editor, Energy Desk', org:'The Standard', sector:'media', layer:2, sensitive:false, gender:'male', I:4,R:4,K:2,S:5,A:4,M:4 },
  { id:'s-007', name:'Dr. Rebecca Muthoni', title:'Program Director', org:'UNDP Kenya', sector:'international', layer:2, sensitive:false, gender:'female', I:4,R:5,K:1,S:5,A:5,M:4 },
  { id:'s-008', name:'Prof. David Ngugi', title:'Dean, Engineering', org:'University of Nairobi', sector:'academia', layer:3, sensitive:false, gender:'male', I:4,R:4,K:1,S:5,A:5,M:4 },
  { id:'s-009', name:'Catherine Wambua', title:'Executive Director', org:'Kenya Climate Innovation Centre', sector:'civil_society', layer:2, sensitive:false, gender:'female', I:4,R:5,K:1,S:5,A:5,M:4 },
  { id:'s-010', name:'Hon. Samuel Mwaniki', title:'Vice Chair, Environment Committee', org:'National Assembly', sector:'politics', layer:2, sensitive:false, gender:'male', I:4,R:4,K:2,S:4,A:5,M:4 },
  ...
  { id:'s-016', name:'Stephen Letoo', title:'CEO', org:'Kenya Petroleum Refineries', sector:'business', layer:2, sensitive:true, gender:'male', I:4,R:1,K:5,S:2,A:1,M:4 },
  { id:'s-017', name:'Hon. Moses Kuria', title:'MP, Gatundu South', org:'National Assembly', sector:'politics', layer:2, sensitive:false, gender:'male', I:4,R:2,K:4,S:3,A:2,M:4 },
  { id:'s-018', name:'Dr. Wilson Songa', title:'Commissioner General', org:'KRA', sector:'civil_service', layer:1, sensitive:true, gender:'male', I:5,R:2,K:3,S:3,A:2,M:5 },
  { id:'s-019', name:'Jacob Kaimenyi', title:'CEO', org:'National Oil Corporation', sector:'business', layer:2, sensitive:true, gender:'male', I:4,R:2,K:5,S:2,A:1,M:4 },
  { id:'s-020', name:'Hon. George Muchiri', title:'Chair, Finance Committee', org:'National Assembly', sector:'politics', layer:1, sensitive:true, gender:'male', I:5,R:3,K:3,S:3,A:2,M:5 },
  { id:'s-021', name:'Paul Wekesa', title:'MD', org:'Total Energies Kenya', sector:'business', layer:2, sensitive:false, gender:'male', I:4,R:2,K:4,S:2,A:2,M:4 },
  { id:'s-022', name:'Mary Waceera', title:'County Commissioner', org:'Nairobi County', sector:'civil_service', layer:2, sensitive:false, gender:'female', I:4,R:3,K:3,S:3,A:2,M:4 },
  { id:'s-023', name:'Anthony Mwaura', title:'Director', org:'KEBS', sector:'civil_service', layer:3, sensitive:false, gender:'male', I:4,R:2,K:3,S:3,A:2,M:4 },
  { id:'s-024', name:'Victoria Kimani', title:'CEO', org:'ICDC', sector:'business', layer:2, sensitive:false, gender:'female', I:4,R:2,K:3,S:3,A:3,M:4 },
  { id:'s-025', name:'Hon. Patrick Makau', title:'Senate Majority Whip', org:'Senate', sector:'politics', layer:1, sensitive:true, gender:'male', I:5,R:3,K:3,S:3,A:2,M:4 },
  ...
  { id:'s-039', name:'Daniel Mwanzia', title:'Small Business Owner', org:'SME Federation', sector:'business', layer:3, sensitive:false, gender:'male', I:1,R:2,K:3,S:3,A:2,M:1 },
  { id:'s-040', name:'Esther Kamau', title:'Junior Researcher', org:'Kenya Power', sector:'business', layer:3, sensitive:false, gender:'female', I:2,R:3,K:3,S:3,A:3,M:2 },
  { id:'s-041', name:'Philip Ochieng', title:'Community Organizer', org:'Nairobi Residents Association', sector:'civil_society', layer:3, sensitive:false, gender:'male', I:2,R:2,K:3,S:2,A:3,M:1 },
  { id:'s-042', name:'Margaret Wanjiku', title:'Retired Diplomat', org:'Independent', sector:'politics', layer:3, sensitive:false, gender:'female', I:3,R:2,K:2,S:3,A:3,M:2 },
  { id:'s-043', name:'George Oloo', title:'Reporter', org:'KTN', sector:'media', layer:3, sensitive:false, gender:'male', I:2,R:1,K:4,S:2,A:2,M:2 },
  { id:'s-044', name:'Francis Njuguna', title:'District Officer', org:'Kiambu County', sector:'civil_service', layer:3, sensitive:false, gender:'male', I:2,R:2,K:3,S:3,A:2,M:2 },
  { id:'s-045', name:'Susan Cherop', title:'NGO Coordinator', org:'Water & Sanitation Network', sector:'civil_society', layer:3, sensitive:false, gender:'female', I:2,R:3,K:3,S:3,A:3,M:2 },
  { id:'s-046', name:'Robert Kiptoo', title:'Lecturer', org:'Kenyatta University', sector:'academia', layer:3, sensitive:false, gender:'male', I:2,R:2,K:2,S:3,A:3,M:2 },
...
export const watchlistSignals: WatchlistSignal[] = [
  ...
  { id:'ws-007', stakeholder_id:'s-004', signal_type:'sis_rise', severity:'medium', description:'Michael Odhiambo SIS increased by 18 points following a successful engagement drive. Now classified as Strategic Ally.', is_resolved:true, triggered_at:fmt(subDays(NOW,45)), resolved_at:fmt(subDays(NOW,30)) },
